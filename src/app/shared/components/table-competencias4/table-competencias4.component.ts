...
import { Competencias4, Comportamientos, Calificaciones } from '../../../utils/data';
import {
  FormGroup,
  FormControl,
  ReactiveFormsModule,
...
@Component({
  selector: 'app-table-competencias4',
  standalone: true,
  imports: [ReactiveFormsModule],
  templateUrl: './table-competencias4.component.html',
  styles: ``
})
export class TableCompetencias4Component {
  competencias4 = Competencias4;
