...
@Component({
  selector: 'app-competencias2-table',
  standalone: true,
  imports: [CommonModule, FormsModule, PdfReporteComponent],
  templateUrl: './competencias2-table.component.html',
})
export class Competencias2TableComponent {
  ...
  formData = signal<DatosPuesto>({
    ...
    competencias: {
      comportamiento: {
        comportamiento1: { name: '', value: '' },
        comportamiento2: { name: '', value: '' },
        comportamiento3: { name: '', value: '' },
        comportamiento4: { name: '', value: '' },
        comportamiento5: { name: '', value: '' },
        comportamiento6: { name: '', value: '' },
      },
      proceso: {
        proceso1: { name: '', value: '' },
        proceso2: { name: '', value: '' },
        ...
        proceso8: { name: '', value: '' },
        proceso9: { name: '', value: '' },
        proceso10: { name: '', value: '' },
        proceso11: { name: '', value: '' },
        proceso12: { name: '', value: '' },
      },
    },
    control: {
      aprobo: '',
