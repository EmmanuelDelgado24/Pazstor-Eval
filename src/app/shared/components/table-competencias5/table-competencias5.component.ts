...
import { Competencias5, Comportamientos, Calificaciones } from '../../../utils/data';
import {
  FormGroup,
  FormControl,
  ReactiveFormsModule,
...
@Component({
  selector: 'app-table-competencias5',
  standalone: true,
  imports: [ReactiveFormsModule],
  templateUrl: './table-competencias5.component.html',
  styles: ``
})
export class TableCompetencias5Component {
  competencias5 = Competencias5;
