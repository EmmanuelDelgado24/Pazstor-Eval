...
import { Competencias3, Comportamientos, Calificaciones } from '../../../utils/data';
import {
  FormGroup,
  FormControl,
  ReactiveFormsModule,
...
@Component({
  selector: 'app-table-competencias3',
  standalone: true,
  imports: [ReactiveFormsModule],
  templateUrl: './table-competencias3.component.html',
  styles: ``
})
export class TableCompetencias3Component {
  competencias3 = Competencias3;
