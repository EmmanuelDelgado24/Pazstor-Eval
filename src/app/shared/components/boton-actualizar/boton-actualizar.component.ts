...
import { DatosService } from '../../../core/services/datos.services';

@Component({
  selector: 'app-boton-competencias',
  standalone: true,
  imports: [CommonModule, CompetenciasTableComponent],
  templateUrl: './boton-actualizar.component.html'
})
export class BotonCompetenciasComponent {
